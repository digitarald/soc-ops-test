    ...
    <div className="min-h-full overflow-hidden bg-gradient-to-br from-[#ff6b35] via-[#f72585] to-[#00b4d8] animate-gradient">
      ...
      <div className="flex flex-col items-center justify-center min-h-[90vh] px-6 py-12 text-white">
        <div className="max-w-4xl w-full text-center">
          {/* Headline */}
          <h1 
            className="text-5xl sm:text-6xl md:text-7xl font-bold mb-6 initial-hidden animate-fade-up"
          ...
          {/* Subheadline */}
          <p 
            className="text-xl sm:text-2xl md:text-3xl mb-10 text-white/90 font-medium initial-hidden animate-fade-up delay-100"
          ...
          <button
            onClick={onStart}
            className="initial-hidden animate-bounce-in delay-200 bg-white text-[#f72585] font-bold text-xl sm:text-2xl px-10 py-5 rounded-full shadow-2xl hover:scale-110 hover:rotate-2 active:scale-95 transition-all duration-300"
            style={{ fontFamily: 'var(--font-display)' }}
          >
            🎉 Start Playing Now!
          </button>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl hover:scale-105 transition-transform duration-300">
              ...
              <h3 
                className="text-xl font-bold mb-2 text-[#ff6b35]"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                No Setup Required
              </h3>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl hover:scale-105 transition-transform duration-300">
              <div className="text-5xl mb-4">📱</div>
              <h3 
                className="text-xl font-bold mb-2 text-[#00b4d8]"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                Mobile-Friendly
              </h3>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl hover:scale-105 transition-transform duration-300">
              <div className="text-5xl mb-4">🎊</div>
              <h3 
                className="text-xl font-bold mb-2 text-[#f72585]"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                Instant Fun
              </h3>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-xl hover:scale-105 transition-transform duration-300">
              <div className="text-5xl mb-4">🎯</div>
              <h3 
                className="text-xl font-bold mb-2 text-[#06d6a0]"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                Perfect for Events
              </h3>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4 bg-white/20 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/30 transition-colors">
              <div 
                className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#ffd60a] text-[#ff6b35] flex items-center justify-center text-2xl sm:text-3xl font-bold shadow-lg"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                1
              </div>
            ...
            <div className="flex items-start gap-4 bg-white/20 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/30 transition-colors">
              <div 
                className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#ffd60a] text-[#00b4d8] flex items-center justify-center text-2xl sm:text-3xl font-bold shadow-lg"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                2
              </div>
            ...
            <div className="flex items-start gap-4 bg-white/20 backdrop-blur-sm rounded-2xl p-6 hover:bg-white/30 transition-colors">
              <div 
                className="flex-shrink-0 w-12 h-12 sm:w-16 sm:h-16 rounded-full bg-[#ffd60a] text-[#f72585] flex items-center justify-center text-2xl sm:text-3xl font-bold shadow-lg"
                style={{ fontFamily: 'var(--font-display)' }}
              >
                3
              </div>
      ...
      <div className="px-6 py-16 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <button
            onClick={onStart}
            className="bg-white text-[#f72585] font-bold text-xl sm:text-2xl px-10 py-5 rounded-full shadow-2xl hover:scale-110 hover:-rotate-2 active:scale-95 transition-all duration-300"
            style={{ fontFamily: 'var(--font-display)' }}
          >
            🚀 Let's Go!
          </button>
